...
class FavoriteViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITabBarControllerDelegate   {
    ...
    override func viewDidLoad() {
        ...
        appDelegate.favoriteViewController = self
    ...
    func getValueFavorite(){
        self.keyArray.removeAll()
        
        self.ref.child("favorite").child(user!.uid).observeSingleEvent(of: .value) { (snapshot) in
